	...
	protected Notification createNotification() {
	    ...
	    if (Build.VERSION.SDK_INT < 16) {
	      Notification.Builder builder = new Notification.Builder(this).setAutoCancel(true)
	          .setContentTitle(this.getString(R.string.app_name)).setContentText(this.getString(R.string.loading))
	          .setContentIntent(contentIntent)
	          .setSmallIcon(R.drawable.script_logo_48).setWhen(System.currentTimeMillis())
	          .setOngoing(true);
	      notification = builder.getNotification();
	    } else {
	    	notification = new Notification.Builder(this).setAutoCancel(true).
	    		  setContentTitle(this.getString(R.string.app_name))
	          .setContentText(this.getString(R.string.loading)).setContentIntent(contentIntent)
	          .setSmallIcon(R.drawable.script_logo_48).setWhen(System.currentTimeMillis()).build();
	    }
