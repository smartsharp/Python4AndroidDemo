...
public class AndroidFacade extends RpcReceiver {
  ...
  public Intent startActivityForResult(@RpcParameter(name = "action") String action,
  ...
  public void startActivity(@RpcParameter(name = "action") String action,
      @RpcParameter(name = "uri") @RpcOptional String uri,
      @RpcParameter(name = "type", description = "MIME type/subtype of the URI") @RpcOptional String type,
      @RpcParameter(name = "extras", description = "a Map of extras to add to the Intent") @RpcOptional JSONObject extras,
  ...
  public void sendBroadcast(@RpcParameter(name = "action") String action,
      @RpcParameter(name = "uri") @RpcOptional String uri,
      @RpcParameter(name = "type", description = "MIME type/subtype of the URI") @RpcOptional String type,
      @RpcParameter(name = "extras", description = "a Map of extras to add to the Intent") @RpcOptional JSONObject extras,
      @RpcParameter(name = "packagename", description = "name of package. If used, requires classname to be useful") @RpcOptional String packagename,
  ...
  public void notify(@RpcParameter(name = "title", description = "title") String title,
    ...
    if (Build.VERSION.SDK_INT < 16) {
      /*
       * notification = new Notification(mResources.getLogo48(), message,
       * System.currentTimeMillis()); // This contentIntent is a noop.
       * notification.setLatestEventInfo(mService, title, message, contentIntent);
       * notification.flags = Notification.FLAG_AUTO_CANCEL;
       */
      Notification.Builder builder = new Notification.Builder(mService).setAutoCancel(true)
          .setContentTitle(title).setContentText(message).setContentIntent(contentIntent)
          .setSmallIcon(mResources.getLogo48()).setWhen(System.currentTimeMillis())
          .setOngoing(true);
      notification = builder.getNotification();
    } else {
      notification = new Notification.Builder(mService).setAutoCancel(true).setContentTitle(title)
          .setContentText(message).setContentIntent(contentIntent)
          .setSmallIcon(mResources.getLogo48()).setWhen(System.currentTimeMillis()).build();
    }
